package de.fhdo.lemma.model_processing.visualizer.graphviz.commandline
...
internal object ModuleCommandLine {
    ...
    // Skips normal generation and creates an example picture
    @CommandLine.Option(
        names = ["--exampleMode"],
        paramLabel = "EXAMPLE",
        description = ["Skips normal generation and creates an example picture."]
    )
