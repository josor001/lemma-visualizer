...
# can receive a single argument to identify the version of the visualizer
# to pass it to the Dockerfile. The current version of the visualizer may be found
# may be found in the "de.fhdo.lemma.model_processing.visualizer/gradle.properties" file. In case
